            ...
            <div className="navbar__container container">
                ...
                <div className="navbar__menu">
                    <ul className="navbar__menu-list">
                        ...
                        <li className="navbar__menu-item"><NavLink to="/employees/new" className={({isActive}) => isActive ? "navbar__menu-link active" : "navbar__menu-link" } target="_self">Add New Employee</NavLink></li>
                    </ul>
                </div>
